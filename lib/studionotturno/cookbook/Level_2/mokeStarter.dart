...
class MokeStarter{
  ...
  void caricaRicette2() {
    ...
    cookBook.clear();
    cookBook.addRecipe("q");
    cookBook.getRecipe("q").setDifficult(3);
    cookBook.getRecipe("q").setDescription("una descrizione molto bella e molto lunga per far vedere che c'p una descrizione interssante e molto avvincente perchè a noi piace programmare");
    cookBook.getRecipe("q").setExecutionTime(new ExecutionTime(0,30));
