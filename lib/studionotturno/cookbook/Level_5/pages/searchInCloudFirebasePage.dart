...
@deprecated
class SearchInCloudFirebasePage extends StatefulWidget{

  SearchInCloudFirebasePage();

  @override
  State<StatefulWidget> createState()=>SearchInCloudFirebasePageState();

}

class SearchInCloudFirebasePageState extends State<SearchInCloudFirebasePage>{
  ...
  //ConcreteCollection_ProxyFirestore proxyClient;
  ...
  SearchInCloudFirebasePageState(){
    this.resourceFinded=new Set<Resource>();
    //this.proxyClient=new ConcreteCollection_ProxyFirestore();
